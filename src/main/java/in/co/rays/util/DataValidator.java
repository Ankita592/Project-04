...
public class DataValidator {
	...
	/* System.out.println(isInteger("123"));  // Output: true (valid integer)
	System.out.println(isInteger("abc"));  // Output: false (invalid string, caught by NumberFormatException)
	System.out.println(isInteger("123abc"));// Output: false (invalid string, caught by NumberFormatException)
    */
...
/*Yeh regex check karta hai ki name letters, spaces, periods, apostrophes, aur hyphens se bana ho
aur shuruat hyphen ya space se na ho. */
	...
	//Must start with a digit between 6 and 9.
	//Followed by exactly nine more digits (for a total of ten digits).
	//Must not contain any additional characters before or after these digits.
